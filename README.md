# FightCamp Project - Deel 1
**Student:** Islam Sadaev

## V0.app link

* **Link:** `https://v0.app/chat/fight-camp-mma-tracker-otAUTYC5tcF?ref=FUZIPQ`

## Test Credentials (uit Seed)
Gebruik deze gegevens om in te loggen (deze gebruiker wordt aangemaakt door `pnpm prisma db seed`):
